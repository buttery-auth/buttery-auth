...
const features = [
	{
		name: "Email & Password",
		link: "https://www.buttery-auth.com/docs/authentication/email-password",
	},
	{
		name: "Organization | Teams",
		link: "https://www.buttery-auth.com/docs/plugins/organization",
	},
	{
		name: "Passkeys",
		link: "https://www.buttery-auth.com/docs/plugins/passkey",
	},
	{
		name: "Multi Factor",
		link: "https://www.buttery-auth.com/docs/plugins/2fa",
	},
	{
		name: "Password Reset",
		link: "https://www.buttery-auth.com/docs/authentication/email-password#request-password-reset",
	},
	{
		name: "Email Verification",
		link: "https://www.buttery-auth.com/docs/authentication/email-password#email-verification",
	},
	{
		name: "Roles & Permissions",
		link: "https://www.buttery-auth.com/docs/plugins/organization#roles",
	},
	{
		name: "Rate Limiting",
		link: "https://www.buttery-auth.com/docs/reference/security#rate-limiting",
	},
	{
		name: "Session Management",
		link: "https://www.buttery-auth.com/docs/concepts/session-management",
	},
];
						...
						<div className="border-y py-2 border-dotted bg-secondary/60 opacity-80">
							<div className="text-xs flex items-center gap-2 justify-center text-muted-foreground ">
								<span className="text-center">
									All features on this demo are implemented with Buttery Auth
