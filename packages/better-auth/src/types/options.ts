...
import type { ButteryAuthPlugin } from "./plugins";
...
import type { CookieOptions } from "buttery-call";
import type { Database } from "buttery-sqlite3";
...
export type ButteryAuthOptions = {
	/**
	 * The name of the application
	 *
	 * process.env.APP_NAME
	 *
	 * @default "Buttery Auth"
	 */
	appName?: string;
	/**
	 * Base URL for the Buttery Auth. This is typically the
	...
	baseURL?: string;
	/**
	 * Base path for the Buttery Auth. This is typically
	 * the path where the
	 * Buttery Auth routes are mounted.
	 *
	 * @default "/api/auth"
	 */
	basePath?: string;
	 ...
	 * signing and hashing.
	 *
	 * By default Buttery Auth will look for
	...
	/**
	 * List of Buttery Auth plugins
	 */
	plugins?: ButteryAuthPlugin[];
	/**
	 * User configuration
	 */
	user?: {
	...
	advanced?: {
		...
		ipAddress?: {
			 ...
			 *
			 * @default
			 * @link https://github.com/buttery-auth/buttery-auth/blob/main/packages/better-auth/src/utils/get-request-ip.ts#L8
			 */
		 ...
		 * @default
		 * ```txt
		 * "appName" -> which defaults to "buttery-auth"
		 * ```
		 */
		cookiePrefix?: string;
		/**
