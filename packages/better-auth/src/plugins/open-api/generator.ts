...
import type { AuthContext, ButteryAuthOptions } from "../../types";
...
export async function generator(ctx: AuthContext, options: ButteryAuthOptions) {
	...
	const res = {
		...
		info: {
			title: "Buttery Auth",
			description: "API Reference for your Buttery Auth Instance",
			version: "1.1.0",
		},
		components: {
			...components,
		...
		tags: [
			{
				name: "Default",
				description:
					"Default endpoints that are included with Buttery Auth by default. These endpoints are not part of any plugin.",
			},
		],
		paths,
	};
