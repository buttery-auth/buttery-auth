...
export interface AuthorizationQuery {
	 ...
	 *
	 * Note: Buttery Auth stores the state in a database instead of a cookie. - This is to minimize
	 ...
	 * designation).
	 *
	 * Buttery Auth does not support this parameter yet. It'll not throw an error if it's provided,
	 *
