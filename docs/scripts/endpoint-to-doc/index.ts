import type { createAuthEndpoint as BAcreateAuthEndpoint } from "buttery-auth/api";
import { z } from "zod";
import fs from "fs";
...
function generateJSDoc({
	 ...
	 *
	 * @see [Read our docs to learn more.](https://buttery-auth.com/docs/plugins/organization#api-method-organization-set-active)
	 */
	...
	jsdoc.push(
		`@see [Read our docs to learn more.](https://buttery-auth.com/docs/plugins/${
			path.split("/")[1]
