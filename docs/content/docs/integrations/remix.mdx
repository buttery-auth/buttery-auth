...
description: Integrate Buttery Auth with Remix.
---

Buttery Auth can be easily integrated with Remix. This guide will show you how to integrate Buttery Auth with Remix.
...
And in this file, import Buttery Auth and create your instance.
...
<Callout type="info">
 You can change the path on your buttery-auth configuration but it's recommended to keep it as `routes/api.auth.$.ts`
</Callout>
