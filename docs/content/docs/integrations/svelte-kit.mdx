...
description: Integrate Buttery Auth with SvelteKit.
---
...
You need to add it as a plugin to your Buttery Auth instance.
...
import { createAuthClient } from "buttery-auth/svelte"; // make sure to import from buttery-auth/svelte
