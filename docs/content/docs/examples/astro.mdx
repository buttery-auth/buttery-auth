---
title: Astro Example
description: Buttery Auth Astro example.
---
...
<ForkButton url="buttery-auth/buttery-auth/tree/main/examples/astro-example"  />

<iframe src="https://stackblitz.com/github/buttery-auth/buttery-auth/tree/main/examples/astro-example?codemirror=1&fontsize=14&hidenavigation=1&runonclick=1&hidedevtools=1"
   style={{
      width: "100%",
      height: "500px",
      border: 0,
   ...
   title="Buttery Auth Astro+Solid Example"
