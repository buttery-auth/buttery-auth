...
description: A step-by-step guide to creating a browser extension with Buttery Auth.
---

In this guide, we'll walk you through the steps of creating a browser extension using <Link href="https://docs.plasmo.com/">Plasmo</Link> with Buttery Auth for authentication.

If you would like to view a completed example, you can check out the <Link href="https://github.com/buttery-auth/buttery-auth/tree/main/examples/browser-extension-example">browser extension example</Link>.

<Callout type="warn">
  The Plasmo framework does not provide a backend for the browser extension.
  This guide assumes you have{" "}
  <Link href="/docs/integrations/hono">a backend setup</Link> of Buttery Auth and
...
<Steps>
    ...
    <Step>
        ...
        Then, install the Buttery Auth package.

        ```bash
        pnpm add buttery-auth
        ```
    ...
    <Step>
        ...
        We must ensure the extension knows the URL to the Buttery Auth backend.
    ...
    <Step>
        ...
        You have now set up Buttery Auth for your browser extension.

        Add your desired UI and create your dream extension!

        To learn more about the client Buttery Auth API, check out the <Link href="/docs/concepts/client">client documentation</Link>.
...
Congratulations! You've successfully created a browser extension using Buttery Auth and Plasmo.
...
If you have any questions, feel free to open an issue on our <Link href="https://github.com/buttery-auth/buttery-auth/issues">GitHub repo</Link>, or join our <Link href="https://discord.gg/buttery-auth">Discord server</Link> for support.
