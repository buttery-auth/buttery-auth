...
description: A step-by-step guide to creating your first Buttery Auth plugin.
---

In this guide, we’ll walk you through the steps of creating your first Buttery Auth plugin.


<Callout type="warn">
This guide assumes you have <Link href="/docs/installation">setup the basics</Link> of Buttery Auth and are ready to create your first plugin.
</Callout>
...
<Step>
## Server plugin first
Buttery Auth plugins operate as a pair: a <Link href="/docs/concepts/plugins#create-a-server-plugin">server plugin</Link> and a <Link href="/docs/concepts/plugins#create-a-client-plugin">client plugin</Link>.
...
By creating a schema here, this also allows <Link href="/docs/concepts/cli">Buttery Auth’s CLI</Link> to generate the schemas required to update your database.
...
```ts title="client.ts"
import { BetterAuthClientPlugin } from "buttery-auth";
...
Congratulations! You’ve successfully created your first ever Buttery Auth plugin.
...
our <Link href="https://discord.gg/buttery-auth">Discord server</Link>,
or through a <Link href="https://github.com/buttery-auth/buttery-auth/pulls">pull-request</Link>
