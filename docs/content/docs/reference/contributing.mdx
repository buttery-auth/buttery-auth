---
title: Contributing to ButteryAuth
description: A concise guide to contributing to ButteryAuth
---

Thank you for your interest in contributing to Buttery Auth! This guide is a concise guide to contributing to Buttery Auth.

## Getting Started

Before diving in, here are a few important resources:

- Take a look at our existing <Link href="https://github.com/buttery-auth/buttery-auth/issues">issues</Link> and <Link href="https://github.com/buttery-auth/buttery-auth/pulls">pull requests</Link>
- Join our community discussions in <Link href="https://discord.gg/buttery-auth">Discord</Link>
...
<Steps>
    ...
    <Step>
        ...
        Visit https://github.com/buttery-auth/buttery-auth
    ...
    <Step>
        ...
        git clone https://github.com/YOUR-USERNAME/buttery-auth.git
        cd buttery-auth
        ```
    </Step>
...
- Check our [GitHub issues](https://github.com/buttery-auth/buttery-auth/issues) for tasks labeled `good first issue`
...
- Open an <Link href="https://github.com/buttery-auth/buttery-auth/issues">issue</Link> with questions
- Join our <Link href="https://discord.gg/buttery-auth">community discussions</Link>
- Reach out to project maintainers

Thank you for contributing to Buttery Auth!
