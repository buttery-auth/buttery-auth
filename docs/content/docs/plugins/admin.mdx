---
title: Admin
description: Admin plugin for Buttery Auth
---
...
<Steps>
  <Step>
    ...
    import { admin } from "buttery-auth/plugins" // [!code highlight]
  ...
  <Step>
    ...
    import { adminClient } from "buttery-auth/client/plugins"
...
<Steps>
   ...
   export const admin = ac.newRole({ // [!code highlight]
    ...
    ```ts title="permissions.ts"
    import { createAccessControl } from "buttery-auth/plugins/access";
    import { defaultStatements, adminAc } from "buttery-auth/plugins/admin/access";
    ...
    <Step>
        ...
        ```ts title="auth.ts"
        import { betterAuth } from "buttery-auth"
        import { admin as adminPlugin } from "buttery-auth/plugins"
