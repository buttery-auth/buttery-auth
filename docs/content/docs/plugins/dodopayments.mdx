---
title: Dodo Payments
description: Buttery Auth Plugin for Dodo Payments
---
...
```bash
npm install @dodopayments/buttery-auth dodopayments buttery-auth zod
```
...
import {
  ...
  portal,
  webhooks,
} from "@dodopayments/buttery-auth";
...
```typescript
import { dodopaymentsClient } from "@dodopayments/buttery-auth";
