---
title: OIDC Provider
description: Open ID Connect plugin for Buttery Auth that allows you to have your own OIDC provider.
---
...
<Callout type="warn">
This plugin is in active development and may not be suitable for production use. Please report any issues or bugs on [GitHub](https://github.com/buttery-auth/buttery-auth).
</Callout>
...
<Steps>
    <Step>
        ...
        import { oidcProvider } from "buttery-auth/plugins";
    ...
    <Step>
        ...
        import { oidcClient } from "buttery-auth/client/plugins"
...
import { betterAuth } from "buttery-auth";
import { oidcProvider } from "buttery-auth/plugins";
import { jwt } from "buttery-auth/plugins";
