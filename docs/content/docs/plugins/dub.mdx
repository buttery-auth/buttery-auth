---
title: Dub
description: Buttery Auth Plugin for Lead Tracking using Dub links and OAuth Linking
---
...
<Steps>
    ...
    <Step>
        ...
        import { dubAnalytics } from "@dub/buttery-auth"
        import { dub } from "dub"
...
import { dubAnalyticsClient } from "@dub/buttery-auth/client";
