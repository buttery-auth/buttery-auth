---
title: Anonymous  
description: Anonymous plugin for Buttery Auth.
---
...
<Steps>
  <Step>
    ...
    import { anonymous } from "buttery-auth/plugins" // [!code highlight]
  ...
  <Step>
    ...
    import { anonymousClient } from "buttery-auth/client/plugins"
