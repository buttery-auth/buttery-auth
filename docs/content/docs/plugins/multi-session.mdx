---
title: Multi Session
description: Learn how to use multi-session plugin in Buttery Auth.
---
...
import { multiSession } from "buttery-auth/plugins"
...
<Step>
        ...
        import { multiSessionClient } from "buttery-auth/client/plugins"
