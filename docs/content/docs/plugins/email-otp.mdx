---
title: Email OTP
description: Email OTP plugin for Buttery Auth.
---
...
<Steps>
  <Step>
    ...
    import { emailOTP } from "buttery-auth/plugins" // [!code highlight]
    ...
    import { emailOTPClient } from "buttery-auth/client/plugins"
