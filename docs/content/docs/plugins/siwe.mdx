...
description: Sign in with Ethereum plugin for Buttery Auth
---
...
<Steps>
    ...
    <Step>
        ...
        import { siweClient } from "buttery-auth/client/plugins";
...
import { betterAuth } from "buttery-auth";
import { siwe } from "buttery-auth/plugins";
import { generateRandomString } from "buttery-auth/crypto";
