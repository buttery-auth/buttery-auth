---
title: API
description: Buttery Auth API.
---

When you create a new Buttery Auth instance, it provides you with an `api` object. This object exposes every endpoint that exist in your Buttery Auth instance. And you can use this to interact with Buttery Auth server side.

Any endpoint added to Buttery Auth, whether from plugins or the core, will be accessible through the `api` object.
