...
export const metadata: Metadata = {
	title: "V1.0 Release",
	description: "Buttery Auth V1.0 release notes",
	openGraph: {
		images: "https://buttery-auth.com/v1-og.png",
		title: "V1.0 Release",
		description: "Buttery Auth V1.0 release notes",
		url: "https://buttery-auth.com/v1",
		type: "article",
		...
		<div className="min-h-screen bg-transparent overflow-hidden">
				...
				<BackgroundLines>
					<div className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 text-center">
						...
						<p className="text-lg text-gray-400 max-w-xl mx-auto">
							We are excited to announce the Buttery Auth V1.0 release.
						</p>
					</div>
				</BackgroundLines>
			</div>
			...
			<div className="relative py-24">
				...
				<div className="max-w-6xl mx-auto px-6 relative z-10">
					...
					<p>
						Since introducing Buttery Auth, the community's excitement has been
						...
						<br /> <br />
						If you were using Buttery Auth for production, we recommend updating
						to V1 as soon as possible. There are some breaking changes, feel
						free to join us on{" "}
						<Link href="https://discord.gg/buttery-auth">Discord</Link>, and
						we'll gladly assist.
					</p>
				</div>
			</div>
			...
			<div className="max-w-6xl mx-auto px-6 relative z-10">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					...
					<div>
						...
						<Link className="w-full" href="https://discord.gg/buttery-auth">
							<Button
								variant="outline"
